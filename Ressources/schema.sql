...
CREATE TABLE IF NOT EXISTS `series`.`ProviderUrl` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ProviderUrl_Episode1_idx` (`Episode_id` ASC),
  INDEX `fk_ProviderUrl_Provider1_idx` (`Provider_id` ASC),
  CONSTRAINT `fk_ProviderUrl_Episode1`
    FOREIGN KEY (`Episode_id`)
    REFERENCES `series`.`Episode` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ProviderUrl_Provider1`
